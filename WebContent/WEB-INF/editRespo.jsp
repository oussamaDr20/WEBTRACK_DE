...
<c:if test="${erreur != null }">
	<H2 style="color: red"" role="alert">
  		<c:out value=" ${erreur} "></c:out>
            ...
            <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>Modifier le responsable: <b>${ responsable.nom}</b></h4>
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="editRespo">
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">Numero du responsable</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="id_respo" readonly="" value="${ responsable.id_respo}"/>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">Nom</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="nom" required placeholder="${ responsable.nom}" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2">Email</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="email" required placeholder="${ responsable.email}"/>
                    </div>
                  </div> 
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2">Photo</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="photo" required placeholder="${ responsable.photo}"/>
                    </div>
                  </div> 
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2">Passwort</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="password" required placeholder="${ responsable.password}"/>
                    </div>
                  </div> 
                  <div class="form-group">
