...
<c:if test="${erreur != null }">
	<H2 style="color: red"" role="alert">
  		<c:out value=" ${erreur} "></c:out>
            ...
            <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>Modifier le dossier numero: <b>${ dossier.id_doc}</b></h4>
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="editDoc">
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">Dateinummer</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="id_doc" readonly="" value="${ dossier.id_doc}"/>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2">Name des Kunden</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="nom_cl" required placeholder="${ dossier.nom_cl}"/>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2">Typ</label>
                    <div class="col-lg-10">
                      <input class="form-control " type="text" name="type" required placeholder="${ dossier.type}"/>
                    </div>
                  </div> 
                  <div class="form-group">
