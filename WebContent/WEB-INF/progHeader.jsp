                            ...
                            <div class="columns is-vcentered">
                                ...
                                <div class="column is-4">
                                    ...
                                    <div class="flex-card header-pricing-card primary hover-inset">
                                        ...
                                        <div class="pricing-card-body">
                                            <div class="plan-price per-month animated preFadeInUp fadeInUp">
                                                <small>Euro</small> 24,9 <small>/ Monat</small>
                                            </div>
                                            <ul class="plan-features">
                                                <li><span class="feature-count-text">Lieferung nach Hause</span></li>
                                                <li><span class="feature-count-text">Verarbeitungspriorität</span></li>
                                                <li><span class="feature-count-text">E-Mail-Benachrichtigung</span></li>
                                            </ul>
                                        </div> 
                                    </div>
                                    <!-- /Pricing table -->
